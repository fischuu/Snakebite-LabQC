...
pipelineFolder="/users/fischerd/git/Snakebite-LabQC"
...
snakemake -s $pipelineFolder/Snakebite-LabQC.smk \
          --configfile $projectFolder/Snakebite-LabQC_config.yaml \
...
snakemake -s $pipelineFolder/Snakebite-LabQC.smk \
          ...
          --configfile $projectFolder/Snakebite-LabQC_config.yaml \
          --latency-wait 60 \
          --cluster-config $projectFolder/Snakebite-LabQC_server-config.yaml \
